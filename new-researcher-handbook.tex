...
\subsection{\faCommentDots~Effective Communication with Your Advisor}

\begin{tcolorbox}[colback=green!5,colframe=green!50,title={\faLightbulb~The Foundation of Productive Meetings}]
...
\begin{enumerate}[leftmargin=1.5em]
    \item \textbf{\faBullseye~Define the Problem Clearly}
    \begin{itemize}
    ...
    \item \textbf{\faCheckCircle~Report What You've Done}
    \begin{itemize}
    ...
    \item \textbf{\faCheck~Clarify What You've Solved}
    \begin{itemize}
    ...
    \item \textbf{\faTimes~Identify What Remains Unsolved}
    \begin{itemize}
    ...
    \item \textbf{\faMapSigns~Present Your Next Steps}
    \begin{itemize}
    ...
    \item \textbf{\faHandshake~Engage in Active Discussion}
    \begin{itemize}
...
\begin{tcolorbox}[colback=yellow!5,colframe=orange!60,title={\faExclamationTriangle~Common Pitfalls to Avoid}]
\begin{itemize}
...
\begin{tcolorbox}[colback=blue!5,colframe=blue!40,title={\faThumbtack~Meeting Preparation Checklist}]
Before each advisor meeting, prepare:
\begin{itemize}
    \item \faFile~Written summary of progress (even if brief)
    \item \faChartLine~Visual evidence (plots, tables, architecture diagrams)
    \item \faQuestionCircle~Specific questions ranked by priority
    \item \faLightbulb~Your proposed solutions to current challenges
    \item \faCalendarCheck~Concrete plan for the next period
\end{itemize}
\end{tcolorbox}
